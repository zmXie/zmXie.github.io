...
"use strict";
/* harmony import */ var _mini_css_extract_plugin_dist_loader_js_css_loader_dist_cjs_js_ref_13_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_13_oneOf_1_2_stylus_loader_index_js_ref_13_oneOf_1_3_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_2_id_1e68bc8d_lang_stylus_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(510);
/* harmony import */ var _mini_css_extract_plugin_dist_loader_js_css_loader_dist_cjs_js_ref_13_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_13_oneOf_1_2_stylus_loader_index_js_ref_13_oneOf_1_3_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_2_id_1e68bc8d_lang_stylus_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_mini_css_extract_plugin_dist_loader_js_css_loader_dist_cjs_js_ref_13_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_13_oneOf_1_2_stylus_loader_index_js_ref_13_oneOf_1_3_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_2_id_1e68bc8d_lang_stylus_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('Common',{staticClass:"categories-wrapper",attrs:{"sidebar":false}},[_c('ModuleTransition',[_c('ul',{directives:[{name:"show",rawName:"v-show",value:(_vm.recoShowModule),expression:"recoShowModule"}],staticClass:"category-wrapper"},_vm._l((_vm.$categoriesList),function(item,index){return _c('li',{directives:[{name:"show",rawName:"v-show",value:(item.pages.length > 0),expression:"item.pages.length > 0"}],key:index,staticClass:"category-item",class:_vm.title == item.name ? 'active': ''},[_c('router-link',{attrs:{"to":item.path}},[_c('span',{staticClass:"category-name"},[_vm._v(_vm._s(item.name))]),_vm._v(" "),_c('span',{staticClass:"post-num",style:({ 'backgroundColor': _vm.getOneColor() })},[_vm._v(_vm._s(item.pages.length))])])],1)}),0)]),_vm._v(" "),_c('ModuleTransition',{attrs:{"delay":"0.08"}},[_c('note-abstract',{directives:[{name:"show",rawName:"v-show",value:(_vm.recoShowModule),expression:"recoShowModule"}],staticClass:"list",attrs:{"data":_vm.posts},on:{"paginationChange":_vm.paginationChange}})],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./node_modules/vuepress-theme-reco/layouts/Category.vue?vue&type=template&id=1e68bc8d&scoped=true&
...
var postData = __webpack_require__(81);
...
/* harmony default export */ var Categoryvue_type_script_lang_js_ = (Object(index_esm["b" /* defineComponent */])({
  ...
  setup: function setup(props, ctx) {
    var instance = Object(composable["a" /* useInstance */])();
    var posts = Object(index_esm["a" /* computed */])(function () {
      var posts = instance.$currentCategories.pages;
      posts = Object(postData["a" /* filterPosts */])(posts);
      Object(postData["c" /* sortPostsByStickyAndDate */])(posts);
      return posts;
    });
    var title = Object(index_esm["a" /* computed */])(function () {
      return instance.$currentCategories.key;
    });

    var getCurrentTag = function getCurrentTag(tag) {
...
// CONCATENATED MODULE: ./node_modules/vuepress-theme-reco/layouts/Category.vue?vue&type=script&lang=js&
 /* harmony default export */ var layouts_Categoryvue_type_script_lang_js_ = (Categoryvue_type_script_lang_js_); 
...
// EXTERNAL MODULE: ./node_modules/vuepress-theme-reco/layouts/Category.vue?vue&type=style&index=2&id=1e68bc8d&lang=stylus&scoped=true&
var Categoryvue_type_style_index_2_id_1e68bc8d_lang_stylus_scoped_true_ = __webpack_require__(552);
...
var component = Object(componentNormalizer["a" /* default */])(
  layouts_Categoryvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
